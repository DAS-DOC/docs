...
## **Security Resources and Downloads**

Access important security-related documents and files:

- <FileDownload href="/files/security/pci-compliance-checklist.pdf" title="PCI Compliance Checklist" icon="file-pdf" />
- <FileDownload href="/files/security/integration-guide.pdf" title="Security Integration Guide" icon="file-pdf" />
- <FileDownload href="/files/security/3ds-implementation.zip" title="3DS Implementation Package" icon="file-zipper" />

To link your own files for download, use the following format:
```md
<FileDownload href="/path/to/your/file.pdf" title="Document Title" icon="file-pdf" />
```

Available icons include: `file-pdf`, `file-word`, `file-excel`, `file-zipper`, `file-code`, and more.
