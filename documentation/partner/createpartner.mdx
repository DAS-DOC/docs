...
<Steps>
  ...
  <Step title="About Your Stakeholders">
    ...
    - **Verify Your Identity**: To complete KYC (Know Your Customer), verify your identity through our secure identity verification process. This step is essential for compliance. Please refer to the [Partner Onboarding Checklist](./partner/partnerchecklist) section to ensure you have all the necessary documents ready for verification.
  </Step>
