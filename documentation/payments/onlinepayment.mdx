...
<CardGroup>
  ...
  <Card title="Getting Started with HPP" icon="rocket">
    Contact our team to set up and customize your Hosted Payment Page. You will receive a unique HPP link to integrate into your website or app.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="OpenCart" icon="basket">
