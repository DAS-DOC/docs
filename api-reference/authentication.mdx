...
* **Using ‘LIVE API KEY’**:
  The **LIVE API KEY** details are available on the website. Provide your LIVE API KEY as the Basic Auth username value. A password is not required.![Payment Options Documentation](/images/flows-authentication-encode.svg)
...
<Update label="12/09/2024" description="version 1.0">
  Add your changelog here
</Update>

1. ;';'

2. <Icon icon="clock-eight" />
