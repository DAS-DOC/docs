...
Access to the API is authenticated using **HTTP Basic Auth** ([Learn More](https://en.wikipedia.org/wiki/Basic_access_authentication)) along with the `x-api-key` header.
...
- **Using ‘LIVE API KEY’**:  
   The **LIVE API KEY** details are available on the website. Provide your LIVE API KEY as the Basic Auth username value. A password is not required.
