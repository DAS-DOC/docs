...
To help you get started with merchant configuration, you can download these helpful resources:

* <a href="/downloads/sample-merchant-config.json" download>Sample Merchant Configuration Template (JSON)</a>
* <a href="/downloads/merchant-setup-checklist.pdf" download>Merchant Setup Checklist (PDF)</a>
* <a href="/downloads/api-payload-examples.zip" download>API Payload Examples (ZIP)</a>

For files hosted in external storage or CDN:
* [Download Integration Guide](https://storage.example.com/docs/integration-guide.pdf)
