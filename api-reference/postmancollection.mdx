...
<Steps>
  <Step title="Download the Postman Collection">
    ...
    <a href="/downloads/PO-API-References-postman_collection.json.zip" download="/downloads/PO-API-References-postman_collection.json.zip">Download Postman Collection</a>
  </Step>
...
<a href="/static/downloads/PO-MerchantUserGuide-EN.pdf" download="/static/downloads/PO-MerchantUserGuide-EN.pdf">Download Merchant User Guide (PDF)</a>