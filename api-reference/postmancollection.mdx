...
<Steps>
  ...
  <Step title="Download the Postman Collection">
    ...
    [Download Collection](https://yourdomain.com/downloads/PO_Gateway_API_Postman_Collection.json)
  </Step>

  <Step title="Access the Cloud Collection">
    Alternatively, access the collection directly from Postman’s cloud by following this link:
    [PO Gateway API Postman Collection - Cloud Access](https://www.postman.com/collections/your-cloud-collection-link)
  </Step>
...
- [Download Postman Collection](https://yourdomain.com/downloads/PO_Gateway_API_Postman_Collection.json)
- [Cloud Access to Postman Collection](https://www.postman.com/collections/your-cloud-collection-link)
