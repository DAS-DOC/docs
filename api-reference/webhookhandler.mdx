...
```json
"return_url": {
        "webhook_url": "https://webhook.site/543eeda4-b2cf-48c9-be09-4060018d1cfc",
...
To link files for download through webhooks, you have several options:

### **1. Direct Download URLs in Webhook Payload**

When a file is ready for download, the webhook payload can include a secure download URL:

```json
{
  "event_type": "file.ready",
  "file": {
    "download_url": "https://api.example.com/files/download/abc123",
...
### **2. Creating Download Links**

To create a download link in your application:

```html
<a href="https://api.example.com/files/download/abc123" download="report.pdf">
  Download File
</a>
```
...
<Warning>
Always validate file download URLs and implement proper authentication before allowing downloads. Never expose direct file system paths in download URLs.
</Warning>