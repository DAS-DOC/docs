---
title: 'Use Token API'
openapi: '/api-reference/usetoken.json POST /api/v1/server-to-server-interface/payment'
operationId: 'UseTokenPayment'
...
```json Request Example
  "payment_method":{
        ...
        "stored_payment_method_id": "0db1fac1-e064-4644-a387-08d143960c8f"
    },  
```
