...
<Update label="2024-12-03" description="Release 20">
  <div style={{ fontSize: '12px', lineHeight: '1.2' }}>
    ...
    * New feature: Onfido integration for Stakeholders KYC in Merchant onboarding

    * New feature: Highlight statements having updated statement transactions

    * New feature: Highlight transactions updated after statement generation

    * New feature: Deep link implementation throughout the Gateway

    * New feature: Implement the Skeleton by replacing loaders throughout the Gateway
    ...
    * Minor enhancement: Add China as a country/entity on Public Holiday

    * Minor enhancement: Remove Subscription Type dropdown menu for Subscription

    * Technical debt item: Improve the logic of access/permission rules throughout the Gateway

    * Minor enhancement: Remove the time zone logic from the due date of a Chargeback Case

    * Minor enhancement: Remove X-API Key for the viewer user in the details drawer

    * Minor enhancement: Retain drawer state on Dispute Management screen

    * Minor enhancement: Add Corporate Website (API) in Merchant onboarding

    * Minor enhancement: Add validations on Corporate Website field

    * Minor enhancement: Update the Terms & Conditions on the Final Step page of self onboarding

    * Minor enhancement: Implement preference for additional column by saving in DB

    * Minor enhancement: Select all the columns by default on Additional Column UI

    * Minor enhancement: Add information marker description for maximum transaction amount in Merchant onboarding

    * Minor enhancement: Resellers as Reselling to Multiple Countries
