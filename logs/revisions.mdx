...
<CardGroup>
  ...
  <Card title="Product Updates" icon="pen-to-square" href="/change-logs/product-updates">
    Stay informed on the latest product enhancements, feature rollouts, and updates.
  </Card>

  <Card title="Merchant User Guide" icon="file-pdf" href="/static/downloads/PO-MerchantUserGuide-EN.pdf">
    Download our comprehensive Merchant User Guide (PDF)
  </Card>
</CardGroup>
